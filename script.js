...
var AnimalTable = /** @class */ (function () {
  ...
  AnimalTable.prototype.generateTableRows = function () {
    ...
    return this.data
      .map(function (animal) {
        return "\n            <tr>\n                <td>"
          .concat(animal.name, "</td>\n                <td>")
          .concat(animal.location, "</td>\n                <td>")
          .concat(animal.size, '</td>\n                <td><img src="')
          .concat(animal.image, '" alt="')
          .concat(
            animal.name,
            '" class="animal-image" width="100"></td>\n                <td>\n                    <button class="btn btn-warning btn-sm" onclick="editAnimal(\''
          )
          .concat(_this.tableBodyId, "', '")
          .concat(
            animal.name,
  ...
  AnimalTable.prototype.add = function (animal) {
    if (
      !this.data.find(function (a) {
        return a.name === animal.name;
      })
    ) {
  ...
  AnimalTable.prototype.edit = function (name, newData) {
    var animal = this.data.find(function (a) {
      return a.name === name;
    });
    if (animal) {
...
function addAnimal(tableId) {
  ...
  var image = prompt("Enter url of animal image");
...
function editAnimal(tableId, name) {
  ...
  var newImage = prompt("Enter new url of image:");
